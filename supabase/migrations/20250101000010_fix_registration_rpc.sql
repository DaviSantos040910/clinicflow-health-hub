-- Migration: Fix Registration RPC
-- Created by Jules
-- This migration ensures the function exists by dropping and recreating it.

DROP FUNCTION IF EXISTS public.create_organization_and_owner(text, text, text, text);
